...
class ResNet(nn.Module):
    ...
    def load(self, ckpt):
        print(f"load {ckpt}.")
        ckpt = torch.load(os.path.join(self.params.save_path, ckpt), map_location=torch.device('cpu'))
    ...
    def save(self, save_name):
        ...
        torch.save(self.model.module.state_dict(), os.path.join(self.params.save_path, save_name))
